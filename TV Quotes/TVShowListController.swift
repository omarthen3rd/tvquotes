...
class TVShowCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        self.backgroundColor = UIColor.coolGray
        let gradient = CAGradientLayer()

        gradient.frame = overlay.bounds
        gradient.colors = [UIColor.black.withAlphaComponent(0.2).cgColor, UIColor.black.withAlphaComponent(0.8).cgColor]
...
class TVShowListController: UICollectionViewController, RefreshDelegate, UIViewControllerPreviewingDelegate {
    ...
    override func viewDidLoad() {
        ...
        collectionView.backgroundColor = UIColor.coolGray
